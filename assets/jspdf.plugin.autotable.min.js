				...
				/***/ 323: /***/ function (__unused_webpack_module, exports) {
					...
					var DocHandler = /** @class */ (function () {
						...
						DocHandler.prototype.rect = function (
							...
							if (
								!["S", "F", "DF", "FD", null].some(function (v) {
									return v === fillStyle;
								})
							) {
								throw new TypeError(
									"Invalid value '".concat(
										fillStyle,
										"' passed to rect. Allowed values are: 'S', 'F', 'DF', 'FD', null"
									)
								);
							}
				...
				/***/ 49: /***/ function (
					...
					function drawBorders(doc, cell, cursor, fillColor, lineWidth) {
						...
						function drawLine(coords, width, color) {
							...
							(_a = doc.getDocument()).line.apply(
								_a,
								__spreadArray(
									__spreadArray([], coords, false),
									[(0, common_1.getFillStyle)(width, color)],
									false
								)
							);
						}
